(() => {
  ...
  function render() {
    ...
    root.innerHTML=`
      <header class="fcr67-head"><div><span>FOUNDER CAPITAL ROOM · R67</span><h2>Fundraising Command Centre</h2><p>Readiness → Round → Data Room → Investors → Outreach → Diligence → Terms → Commitments → Closing → Investor Relations.</p></div><span class="fcr67-mode">${esc(round.source)}</span></header>
      ${moduleFailures()}
