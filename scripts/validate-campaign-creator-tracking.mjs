...
if (!lib.includes('agencyMap')) throw new Error('Delivery-partner roll-up is missing');
...
if (!api.includes('agencyPartnerId')) throw new Error('Reusable delivery partner reference is missing');
