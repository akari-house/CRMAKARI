...
for(const requirement of ['akari-crm-shell-v36','./assets/service-delivery-v4.css?v=33','./assets/service-delivery-v4.js?v=33','app/index.html?runtime=v36'])if(!worker.includes(requirement))throw new Error(`Service-worker shell is missing ${requirement}`);
