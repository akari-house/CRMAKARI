...
for(const requirement of ['akari-crm-shell-v42','./assets/service-delivery-v4.css?v=33','./assets/service-delivery-v4.js?v=33','app/index.html?runtime=v42'])if(!worker.includes(requirement))throw new Error(`Service-worker shell is missing ${requirement}`);
