...
for (const token of ["route==='home'?'dashboard'", "normalizeRoute(route)", "/${normalizeRoute(route)}`", 'cleanAfterBootstrap', "dataset.akariInteractive==='ready'"]) {
...
for (const token of ['/assets/tenant-routing-r6.js?v=4', '/assets/route-clarity-r10.js?v=1']) {
