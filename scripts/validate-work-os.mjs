...
for (const token of ['akari-crm-shell-v42', './assets/my-day-canonical-r8.css?v=1', './assets/my-day-canonical-r8.js?v=1', 'runtime=v42']) if (!sw.includes(token)) throw new Error(`Service worker missing ${token}`);
